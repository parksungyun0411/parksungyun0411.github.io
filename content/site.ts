  ...
  experience: [
    {
      ...
      bullets: [
        ...
        "CSV 제출과 자동 채점 기능은 내보내기 전에 사내에서 실제 대회를 열어 검증했습니다. 참가부터 제출, 채점, 리더보드, 최종 선택, 공개까지 전 과정을 여덟 개 역할로 나눠 단독으로 기획하고 운영했고, 1차 유저사이드 QA에서 이슈 31건을 모았습니다.",
        "게시판과 리더보드, 랭킹을 포함한 스무 개 남짓한 화면의 가로 오버플로를 한 번에 잡았고, 결과물 갤러리는 미리보기 우선순위와 산출물 태그, 인기순 정렬을 기준으로 카드 구조를 다시 짰습니다.",
