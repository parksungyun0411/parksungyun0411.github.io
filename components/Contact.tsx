export default function Contact() {
  return (
    ...
    >
      <div className="text-sm font-mono text-blue-600 mb-3">## contact</div>
      <h2 className="text-3xl sm:text-4xl font-bold text-zinc-900 mb-8">
        연락하기
      </h2>
      <div className="bg-gradient-to-br from-zinc-900 to-zinc-700 text-white rounded-2xl p-10">
        <p className="text-zinc-300 mb-6 max-w-2xl">
          데이터 / AI / 백엔드 협업이나 프로젝트 제안, 채용 관련 문의 환영합니다.
        </p>
        <div className="flex flex-wrap gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 backdrop-blur border border-white/20 rounded-lg transition-colors"
          >
