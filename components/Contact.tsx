export default function Contact() {
  return (
    <section id="contact" className="scroll-mt-24">
      ...
      <h2 className="mb-6 text-2xl font-bold text-zinc-900">연락하기</h2>
      ...
      <div className="flex flex-wrap gap-3 mt-8">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-lg border border-zinc-200 px-5 py-3 text-sm font-medium text-zinc-700 transition-colors hover:border-zinc-300 hover:bg-zinc-50"
        >
          ✉ psyreo@naver.com
        </a>
        <a
